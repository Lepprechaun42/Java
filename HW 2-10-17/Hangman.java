            ...
            if(hangman == 1)
            {
                for(int j = 0; j < 16; j++)
                {
                    ...
                    answer = keys.nextLine();
                        ...
                        {
                            System.out.println("The word contains " + answer + ".");
                            counter++;
                        }
                        else
                        {
